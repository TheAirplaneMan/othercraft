...
-- Seperate Ocean Gravel for Mapgen
...
minetest.register_node("default:leaves", {
	...
	drop = {
		...
		items = {
			...
			{
				-- player will get apple with 1/80 chance
				items = {"default:apple"},
				rarity = 80,
			},
			{
...
minetest.register_node("default:tree_2", {
	description = ("Tree"),
...
minetest.register_node("default:leaves_2", {
	...
	special_tiles = {"default_leaves_2_simple.png"},
	is_ground_content = false,
	groups = {snappy = 3, leafdecay = 3, flammable = 2, leaves = 1},
	drop = {
		max_items = 1,
		items = {
			{items = {"default:sapling_2"}, rarity = 20},
			{items = {"default:leaves_2"}}
		}
	},
	sounds = default.node_sound_leaves_defaults(),
})
...
minetest.register_node("default:tree_3", {
	description = ("Tree"),
	tiles = {"default_tree_top.png", "default_tree_top.png",
...
minetest.register_node("default:leaves_3",{
	...
	drop = {
		max_items = 1,
		items = {
			{items = {"default:sapling_3"}, rarity = 20},
			{items = {"default:leaves_3"}}
		}
	},
	sounds = default.node_sound_leaves_defaults(),
})

minetest.register_node("default:sapling_3", {
	description = ("Sapling"),
	drawtype = "plantlike",
...
minetest.register_node("default:tree_4", {
	description = ("Tree"),
	tiles = {"default_tree_top.png", "default_tree_top.png",
		"default_eucalyptus_tree.png"},
	is_ground_content = false,
	groups = {tree = 1, choppy = 2, oddly_breakable_by_hand = 1, flammable = 2},
	sounds = default.node_sound_wood_defaults(),
})
...
minetest.register_node("default:leaves_4", {
	description = ("Leaves"),
	drawtype = "allfaces_optional",
	tiles = {"default_eucalyptus_leaves.png"},
	special_tiles = {"default_eucalyptus_leaves_simple.png"},
	waving = 1,
	is_ground_content = false,
	groups = {snappy = 3, leafdecay = 3, flammable = 2, leaves = 1},
	drop = {
		max_items = 1,
		items = {
			{items = {"default:sapling_4"}, rarity = 20},
			{items = {"default:leaves_4"}}
		}
	},
	sounds = default.node_sound_leaves_defaults(),
})

minetest.register_node("default:sapling_4", {
	description = ("Sapling"),
	drawtype = "plantlike",
...
minetest.register_node("default:cactus", {
	...
	sunlight_propagates = true,
        damage_per_second = 1,
	groups = {choppy = 3, attached_node = 1},
	sounds = default.node_sound_wood_defaults(),
...
minetest.register_node("default:papyrus", {
	...
	groups = {snappy = 3, flammable = 2, attached_node = 1, dig_immediate = 3},
	sounds = default.node_sound_leaves_defaults(),
...
minetest.register_node("default:dry_shrub", {
	...
	walkable = false,
	buildable_to = true,
	groups = {snappy = 3, flammable = 3, dig_immediate = 3, attached_node = 1},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
...
minetest.register_node("default:grass_tall", {
	...
	groups = {snappy = 3, flora = 1, attached_node = 1, grass = 1,
		normal_grass = 1, dig_immediate = 3, flammable = 1},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
...
minetest.register_node("default:fern", {
	...
	groups = {snappy = 3, flammable = 3, flora = 1, grass = 1,
		fern = 1, dig_immediate = 3, attached_node = 1},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
...
default.register_leafdecay({
	trunks = {"default:tree_2"},
	leaves = {"default:leaves_2"},
	radius = 3,
})
